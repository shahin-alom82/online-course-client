...
const BottomBanner = () => {
      return (
            <div>
                  <Container className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 px-5 gap-6 text-white bg-[#20b794] py-6">
                        {/* Course Section */}
                        <div className="flex items-center gap-4">
                              ...
                              <div>
                                    <p className="text-2xl font-bold">3020+</p>
                                    <p className="text-sm opacity-80">Online Courses
                                    </p>
                              </div>
                        </div>
                        {/* Course Section */}
                        ...
                        <div className="flex items-center gap-4">
                              ...
                              <div>
                                    ...
                                    <p className="text-sm opacity-80">Certifications
                                    </p>
                              </div>
                        </div>
                        {/* Course Section */}
