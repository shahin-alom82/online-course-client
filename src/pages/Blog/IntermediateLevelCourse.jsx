...
const IntermediateLevelCourse = () => {
      const [course] = useCourse();
      const [intermediateCourses, setIntermediateCourses] = useState([]);
      useEffect(() => {
            const filterIntermediateCourses = () => {
                  const filteredCourses = course.filter(item => item.level === "Intermediate");
                        ...
                        <div className="px-4 py-5">
                              ...
                              <div className='mt-6'>
                                    <div className='flex mt-3 items-center gap-2 text-gray-600'>
                                          ...
                                          <FaAngleRight />
                                          <h1 className="text-lg tracking-wide text-gray-800">intermediate level courses</h1>
                                    </div>
                              </div>
                              {/* Blog List */}
...
export default IntermediateLevelCourse;
